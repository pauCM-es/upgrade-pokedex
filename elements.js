//*html elements:
//screens
export const bodyScreenPokemons$$ = document.querySelector("#body-screen__pokemons");
export const bodyPokedexScreen$$ = document.querySelector("#pokedex__ui");
export const detailsScreen$$ = document.querySelector("#details__ui");
...
export const prevEvolBtn$$ = document.querySelector("#evol-prev__btn");
...
export const detailsWeight$$ = document.querySelector("#details__weight");
export const detailsHeight$$ = document.querySelector("#details__height");
